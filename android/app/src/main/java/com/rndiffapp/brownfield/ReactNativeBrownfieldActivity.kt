...
class ReactNativeBrownfieldActivity : ReactActivity(), DefaultHardwareBackBtnHandler, PermissionAwareActivity {
...
//        }
    ...
    companion object {
        ...
        fun createReactActivityIntent(context: Context, moduleName: String, initialProps: Bundle? = null): Intent {
            val intent = Intent(context, ReactNativeBrownfieldActivity::class.java)
